...
const FormHandler = (function() {
    ...
    function populateForm(data) {
        ...
        if (data.theme) {
            ...
            // Update theme options will be handled by the main app
        }
        ...
        if (data.format === 'photo' || data.format === 'international') {
            ...
            if (data.format === 'photo') {
                document.getElementById('photoFormat').click();
            } else {
                document.getElementById('internationalFormat').click();
            }
        }
        ...
        if (data.photo) {
            ...
            // Update CV preview will be handled by the main app
        }
        ...
        if (data.experience && data.experience.length > 0) {
            ...
            CVGenerator.setState({ experienceCount });
        }
        ...
        if (data.education && data.education.length > 0) {
            ...
            CVGenerator.setState({ educationCount });
        }
